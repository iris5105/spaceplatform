...
/* 		border: 1px solid #dcdcdc; */
	...
	#calendar{margin-bottom:50px; padding: 10px; width:230px; color: #505050; border: 1px solid #dcdcdc;}
	#calendar td{padding:10px;	}
	
	#timeTable{margin-bottom:50px; padding: 5px; width:180px; color: #505050;}
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">예약 시간 선택</h5>
			</div>
					...
					<div class="container-sm">
						<div class="row justify-content-center mx-0">
							<div class="col-lg-10">
								...
								<table id="reservation_time" style="margin-top: 0px; margin-bottom: 0px;">
									<tr>
										<td class="top" align="left">시간선택</td>
										<td class="top" align="right"><button
												class="btn btn-info btnTime" type="button"
												onclick="tableinit()">초기화</button></td>
									</tr>
									<tr>
										<td>
											<table id="calendar">
									...
									<tr>
										<td class="content" colspan="2" align="left"><input
											id="selectedDate" name="selectedDate" value=""
											readonly="readonly"></input> <input id="selectedTime"
											name="selectedTime" value="" readonly="readonly"></input> <input
											type="hidden" id="room_no" value="${sp.room_no}"></td>
									</tr>
									<tr>
			...
			<div class="modal-footer">
				<input type="button" id="guest_reserve"
					class="btn btn-info text-wrap" style="width: 150px;" value="예약하러가기">
...
<h6>잘못된 접근입니다</h6>
	...
	<div class="container">
	<span class="badge badge-light" style="font-size: 35px;">${sp.room_nm}</span>
	<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;
	<div class="cols-lg-6">
		<table class="table" border="0" style="width: 540px; font-size: 18px;">
    <tr>
		<th colspan="3" style="font-size: 20px;">방 예약 안내</th>
			<c:if test="${empty memberdto}">
			<th scope="col">
			<img src="resources/img/guest/suit-heart.svg" id="notlike" class="member-unlike float-right" title="찜하기">
			</th></c:if>
		<c:if test="${not empty memberdto}">
			<c:if test="${like==0}">
			<th scope="col">
			<img src="resources/img/guest/suit-heart.svg" id="like" class="member-unlike float-right" title="찜하기">
			</th></c:if>
			<c:if test="${like != 0}">
			<th scope="col">
			<img src="resources/img/guest/suit-heart-fill.svg" id="like" class="member-like float-right" title="찜하기">
			</th></c:if>
		</c:if>
    </tr>
  <tbody>
    <tr>
     ...
     <p class="font-italic" style="font-size: 15px;">확실한 예약을 위해 스페이스에서 온라인 결제를 진행하세요.S2</p>
      <p class="float-center" style="color: #6C757D;">예약가능인원 : 최대 ${sp.room_fit}명</p>
      </td>
    </tr>
    <tr>
      	<td colspan="3"  align="left">
      	<span class="font-weight-bold" style="color: #6C757D;">
     	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     	 ${sp.room_price}원/시간 </span></td>
     	 
      	<td align="right" class="font-weight-bold" >예약일 선택(D-Day) 
      	...
      	<img src="resources/img/guest/calendar3.svg" class="cal">
		    ...
		    <td colspan="4" align="center">
				<div id="divshow" style="display: none;">
									<button type="button" class="btn btn-dark" data-toggle="modal" data-target="#exampleModal">예약하기</button>
								</div>
							</td>
	    </tr>
    <tr>
	...
	<hr class="mb-4">
	<span class="badge badge-light" style="font-size:25px;">${sdto.space_nm}</span>
	
	<hr class="mb-4">
	<h5>${sdto.space_intro}</h5>
	
	<hr class="mb-4">
	<span class="badge badge-light" style="font-size: 23px;">시설안내</span><br>
	<br>
	<p style="font-size: 18px;">${sdto.space_guide}</p>
	
	
  	<hr class="mb-4">
	<span class="badge badge-light" style="font-size: 23px;">방 상세정보</span><br>
	<br>
	<p style="font-size: 18px;">${sp.room_desc}</p>
  
	<hr class="mb-4">
	<span class="badge badge-light" style="font-size: 23px;">주의사항</span>
	<br><br>
	<p style="font-size: 18px;">${sdto.precautions}</p>
	
	<hr class="mb-4">
	<div class="form-row">
		<div class="mb-3 col-md-6">
		<span class="badge badge-light" style="font-size: 23px;">휴무일</span>
		<span style="font-size: 20px;">&nbsp;&nbsp;&nbsp;${sdto.space_closed_dt}</span>
		</div>
		<div class="mb-3 col-md-6">
		<span class="badge badge-light" style="font-size: 23px;">문의</span>
		<span style="font-size: 20px;">&nbsp;${sdto.space_pno}</span>
		</div>
	</div>

	<hr class="mb-4">
	<span class="badge badge-light" style="font-size: 23px;">건물 주소</span><br>
	<br>
	<p style="font-size: 18px;">&nbsp;&nbsp;&nbsp;${sdto.space_addr}</p>
	
	<div id="map" style="width:600px;height:350px;"></div>
	<hr class="mb-4">
	<span class="badge badge-light" style="font-size: 23px;">후기</span>
	<p>
		<div class="col-md-12">
...
$("#like").on("click",function(){
	...
	if($("#like").hasClass("member-unlike")){
		...
		$("#like").toggleClass("member-like float-right");
		
	}else {
		$("#like").removeClass();
		$(this).attr("src","resources/img/guest/suit-heart.svg");
		$("#like").toggleClass("member-unlike float-right");
