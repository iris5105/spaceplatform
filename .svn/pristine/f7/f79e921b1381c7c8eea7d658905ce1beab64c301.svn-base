		...
		<div class="container sp-box">
			<div class="row">
				...
				<div class="col-5" align="center">
					<label for="inputPhone" class="sr-only">전화번호</label> <input
						type="text" id="member_pno" name="member_pno" class="form-control"
						placeholder="전화번호" required autofocus style="height : 45px; width : 400px;"> 
						<input type="hidden" id="member_grade" name="member_grade" value="1"><br>
				</div>
				<div class="col-5">   
				<input type="button" id="emailFind" value="이메일찾기"
						style="height : 45px; width: 100px; background: #E1E9FF; font-family: 'Nanum Gothic'; font-weight: 600; cursor: pointer;">
				</div>
			</div>
			<br>
			<div id="findmail" style="display: none"></div>
			<br>
			<div class="row">
				<div class="col-3"></div>
				<div class="col-3">
					<a class="btn btn-lg btn-primary btn-block" href="host_ssn.do">회원가입</a>
				</div>
				<div class="col-3">
					<a class="btn btn-lg btn-primary btn-block" href="hostLogin.do">로그인</a>
				</div>
			</div>
			<div class="row">
				<div class="col-5"></div>
