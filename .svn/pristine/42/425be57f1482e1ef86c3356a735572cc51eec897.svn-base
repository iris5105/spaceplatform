	...
	<div class="container">
		<div class="row">
				...
				<div class="col-md ">
					<div class="list-group">
						<a href="guest_my_info.do"
							class="list-group-item list-group-item-action">마이페이지</a> <a
			...
			<div class="col-md-9 ">
				...
				<div class="col-md-10">
					<form action="guest_review_edit_ok.do"  method="post"  enctype="multipart/form-data">
						<input type="hidden" name="rev_no" value="${reviewDTO.rev_no}">
						...
						<div class="mb-3">
							...
							<textarea class="form-control" id="rev_content"
								...
								required>${reviewDTO.rev_content}</textarea>
						...
						<div class="mb-3">
				  			...
				  			<input type="hidden" name="res_img2" value="${reviewDTO.res_img}">
						</div>

						<h4 class="mb-0">방이름 ${reviewDTO.res_like}</h4>
						<div class="rating" > 
							...
							<input type="radio" name="res_like" value="1" id="1"><label for="1">★</label>
						</div>
 	...
 	<!--불러온 별 개수 찍기  -->
  	<script type="text/javascript">
  		$(document).ready(function(){
  			$("#contetLength")
  			$("input:radio[name='res_like']:radio[value='${reviewDTO.res_like}']").prop('checked', true);
  		});
	</script> 
